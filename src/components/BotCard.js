  ...
  return (
    <div className="ui column" id={bot.id}>
      <div
        ...
        key={bot.id}
        id={bot.id}
        onClick={handleBotSelect || handleBotSelected}
      >
        <div className="image" onClick={handleBotSelected}>
...
function BotCard({ bot  , handleBotSelect,handleBotSelected, botDelete}) {
  ...
  return (
    <div className="ui column" id={bot.id}>
      <div className="ui card" key={bot.id} id={bot.id} >
        <div className="image" onClick={handleBotSelected}>
          <img alt="oh no!" src={bot.avatar_url} />
        </div>
        <div className="content">
